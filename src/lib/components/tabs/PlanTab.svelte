  ...
  <main class="overflow-y-auto p-4 pb-20">
    {#if tasks.length === 0}
      <div class="flex flex-col items-center justify-center h-full text-center p-8">
        <Calendar class="w-16 h-16 text-muted-foreground/50 mb-4" />
        <h3 class="text-lg font-semibold text-foreground mb-2">No tasks planned yet</h3>
        <p class="text-sm text-muted-foreground mb-6">Plan your first task to stay organized and productive.</p>
      </div>
    {:else}
      <!-- Today -->
      <section class="mb-6">
